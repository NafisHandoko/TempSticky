    ...
    return(
      <>
        ...
        <div className="add-modal" style={this.state.style}>
          <form className={`add-modal-box ${this.state.input.notecolor}`} onSubmit={this.handleSubmit}>
            ...
            <div className="note-color-radio">
              <input type="radio" name="notecolor" className="yellow-radio" value="yellow" onClick={this.handleChange} defaultChecked/>
              <input type="radio" name="notecolor" className="red-radio" value="red" onClick={this.handleChange}/>
              <input type="radio" name="notecolor" className="green-radio" value="green" onClick={this.handleChange}/>
            </div>
          </form>
        </div>
      </>
